...
public class EventBus {
    ...
    private Set<IHandler> iHandlers;
    ...
    public void registered(IHandler iHandler) {
        iHandlers.add(iHandler);
    }

    public void handleMsg(int what, Object o, String msg) {
        for (IHandler handler : iHandlers) {
